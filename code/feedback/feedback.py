...
async def feedback(tasks: List[str] = Query(..., description="사용자 일정 목록")):
    ...
    웹 개발자 취업 준비, 디자이너 취업 준비, 웹 스터디, 인공지능 스터디, 임베디드 스터디, 프로젝트 준비, 디자인 스터디 중 
    ...
    #                         사용자는 생년월일, 전공, 희망직종, 취업 목표 기간(년 단위), 단기 계획 제목, 목표 달성 기간, 필수적인 일정, 기타 요청을 순서대로 입력합니다."""
    userMessageRaw =  """
                    당신은 취업 컨설턴트 AI입니다. 사용자가 입력한 일정들을 기반으로 다음 목록 중 가장 가까운 항목을 반환하세요. 
                    목록 :  [시스템 개발자 취업 준비, 임베디드 개발자 취업 준비, 인공지능 개발자 취업 준비, 
                            웹 개발자 취업 준비, 디자이너 취업 준비, 웹 스터디, 인공지능 스터디, 임베디드 스터디, 프로젝트 준비, 디자인 스터디]
                    
                    [입력 예시]
                        - ['로봇 공학 기본 이론 공부','로봇 프로그래밍 실습','프로젝트 계획 수립','프로젝트 코드 리뷰 및 수정']

...
async def likedSector(sector = str):
    ...
    userMessageRaw =  "### Instruction & Inputs###\
                    ...
                    최근의 event들을 참고하여 '관심종목'의 전망에 대한 당신의 추론과 향후 7일간 가장 주가가 많이 상승할 것 같은 회사 이름 7개를 적되, \
                    기업의 규모가 작은 것부터 우선순위로 잡아 주세요.\
                    주가의 등락폭에 대한 당신의 추론을 기사의 내용을 이용해서 json 형태로 답변해 주세요. 그렇게 생각한 이유는 최대한 구체적이게 작성해 주세요.\
                    \
                    ### Response Format ###\
                    - [['관심종목', '입력받은 관심종목']\
                        ['회사1', '추론근거1'],\
                    ...
                    \
                    if '관심종목' == 게임\
                    - [['게임', '기사에 따르면 최근에 게임 시장의 성장세가 높아지고 있는 가운데, 게임 기업들의 신규 서비스 출시와 성과 향상에 대한 기사가 많아졌습니다. 이러한 분위기 속에서 게임 기업들의 주가가 상승할 것으로 예상됩니다. 따라서, 향후 7일간 가장 주가가 많이 상승할 것으로 예상되는 기업 3곳은 '넥슨', '넷마블', '네오위즈'로 예상됩니다.']\
    ...
    userMessage =  "- 주어진 문장 : {gptAnswer}\
                    ...
                    정해진 형식에 맞게 주어진 문장에서 관심종목과, 선택한 기업과 이유 6개를 추려내어 json데이터로 변환하세요.\
                    기업이름1~6에는 기업의 이름이, 선택이유1~6에는 선택한 이유가 각각 들어가야 하고 반드시 문장으로 끝나야 합니다. '~~해서'의 형태는 금지됩니다.\
...
async def priceList(name: str):
    ...
    """
    price = [50000, 51000, 50500, 52000, 53000]
    return price
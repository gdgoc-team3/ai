...
@router.post("", summary="관심 회사 정보(GPT)")
async def likedSector(sector = str):
    ...
    userMessage =  "당신은 이제부터 '최근 며칠간의 기사 목록'에 대한 dict를 python dictionary로 입력받을 것입니다. \
                    ...
                    기사 목록을 기반으로 한 '관심종목'의 전망에 대한 당신의 추론과\
                    향후 7일간 가장 주가가 많이 상승할 것 같은 회사 이름 3개를 적고, \
                    그 폭에 대한 당신의 추론을 기사의 내용을 이용해서\
                    ...
                    - [['게임', '기사 목록을 살펴본 결과, 최근에 게임 시장의 성장세가 높아지고 있는 가운데, 게임 기업들의 신규 서비스 출시와 성과 향상에 대한 기사가 많아졌습니다. 이러한 분위기 속에서 게임 기업들의 주가가 상승할 것으로 예상됩니다. 따라서, 향후 7일간 가장 주가가 많이 상승할 것으로 예상되는 기업 3곳은 '넥슨', '넷마블', '네오위즈'로 예상됩니다.']\
                        ['넥슨' , '5%', '넥슨은 국내 게임 시장에서 지속적으로 선전하고 있으며, 신규 서비스 출시로 인해 수익성이 개선되고 있는 추세다. 게임 시장 성장을 고려할 때, 주가가 7% 이상 증가할 것으로 예상된다.'],\
                        ['네오위즈' , '8%', '넷플릭스는 콘텐츠 다양성과 글로벌 시장 진출을 통해 안정적인 성과를 거두고 있다. 코로나19로 인한 온라인 엔 터테인먼트 수요 증가로 수익성이 향상되어 주가가 약 8% 상승할 것으로 전망된다.'],\
                        ['넷마블게임즈' , '10%', '넷마블게임즈는 모바일 게임 시장에서 강세를 보여왔고, 최근 출시한 신작으로 기대감이 높아 주가 상승이 예상된다. 게임 시장의 성장세를 고려하면 7일 내 주가가 10% 이상 상승할 것으로 예상한다.'],\
                    #당신의 답변({sectors})\
